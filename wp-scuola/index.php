 ...
 * Theme Name:       	WPScuola
 * File Name:			index.php
 * Description:       	File indice del tema che viane utilizzato per la visualizzazione sotto forma di blog della Home Page
   ...
   <div class="container-fluid">
      <div class="row">
		  <div class="col-12 col-lg-9">
		  	<header class="header">
		  		<h3 class="entry-title"><?php _e('Articoli del Blog', 'wpscuola' ); ?></h3>
		  	</header>
		  	<div class="container">
<?php
		if ( have_posts() ):
